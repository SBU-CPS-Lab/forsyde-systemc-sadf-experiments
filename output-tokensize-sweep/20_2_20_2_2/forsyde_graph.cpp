...
void a5_func(tuple<vector<array<int,4>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a7_func(tuple<vector<array<int,2>>, vector<array<int,4>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a8_func(tuple<vector<array<int,3>>, vector<array<int,2>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a9_func(tuple<vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a11_func(tuple<vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a12_func(tuple<vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
...
void a13_func(tuple<vector<array<int,2>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>, vector<array<int,1>>, vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
        case 0: {
            for(j=0;j<18;j++)
...
void a16_func(tuple<vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a19_func(tuple<vector<array<int,2>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{1, 2, 1, 2, 3, 1, 1, 1, 3, 1, 2, 2, 1, 2, 1, 2, 1, 2, 3, 1}},{1,{2, 1, 2, 1, 3, 1, 1, 2, 2, 1, 1, 2, 3, 2, 2, 2, 2, 2, 3, 1}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch12_delay = SADF::make_delayn("ch12_delay", array<int,2>{}, 6, *ch12_delaysig, *ch12);
        auto ch18_delay = SADF::make_delayn("ch18_delay", array<int,2>{}, 3, *ch18_delaysig, *ch18);
        auto ch23_delay = SADF::make_delayn("ch23_delay", array<int,2>{}, 9, *ch23_delaysig, *ch23);
        auto ch26_delay = SADF::make_delayn("ch26_delay", array<int,3>{}, 3, *ch26_delaysig, *ch26);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{2}, {1}}}, {1, {{1}, {2}}}}, tie(*ch1), *a0_detectorsig, tie( *ch0));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{2}, {1}}}, {1, {{1}, {2}}}}, tie(*ch0), *a1_detectorsig, tie( *ch2));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{1}, {1, 1, 2}}}, {1, {{2}, {2, 1, 1}}}}, tie(*ch6, *ch4, *ch28), *a2_detectorsig, tie( *ch1));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{3}, {2}}}, {1, {{3}, {1}}}}, tie(*ch2), *a3_detectorsig, tie( *ch3));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{1, 2, 1, 1}, {2, 2}}}, {1, {{1, 2, 1, 1}, {2, 1}}}}, tie(*ch30, *ch3), *a4_detectorsig, tie( *ch26_delaysig, *ch12_delaysig, *ch18_delaysig, *ch5_delaysig));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{1}, {1, 3}}}, {1, {{2}, {3, 2}}}}, tie(*ch11, *ch7), *a5_detectorsig, tie( *ch4));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{2}, {3}}}, {1, {{1}, {3}}}}, tie(*ch5), *a6_detectorsig, tie( *ch9));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{1}, {1, 2, 1}}}, {1, {{2}, {2, 2, 3}}}}, tie(*ch15, *ch10, *ch27), *a7_detectorsig, tie( *ch6));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{1}, {2, 2, 1}}}, {1, {{1}, {2, 2, 1}}}}, tie(*ch14, *ch20, *ch8), *a8_detectorsig, tie( *ch7));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{3}, {2}}}, {1, {{2}, {2}}}}, tie(*ch19), *a9_detectorsig, tie( *ch8));
        auto a10 = SADF::make_kernelMN("a10", a10_func, {{0, {{2, 1, 1}, {1}}}, {1, {{2, 2, 2}, {1}}}}, tie(*ch9), *a10_detectorsig, tie( *ch29, *ch25, *ch28));
        auto a11 = SADF::make_kernelMN("a11", a11_func, {{0, {{1}, {1}}}, {1, {{2}, {2}}}}, tie(*ch13), *a11_detectorsig, tie( *ch10));
        auto a12 = SADF::make_kernelMN("a12", a12_func, {{0, {{1, 1}, {1}}}, {1, {{1, 2}, {2}}}}, tie(*ch24), *a12_detectorsig, tie( *ch11, *ch27));
        auto a13 = SADF::make_kernelMN("a13", a13_func, {{0, {{1, 1, 3}, {1, 3}}}, {1, {{2, 1, 2}, {1, 3}}}}, tie(*ch22, *ch12), *a13_detectorsig, tie( *ch31, *ch19, *ch20));
        auto a14 = SADF::make_kernelMN("a14", a14_func, {{0, {{2}, {2}}}, {1, {{2}, {1}}}}, tie(*ch25), *a14_detectorsig, tie( *ch13));
        auto a15 = SADF::make_kernelMN("a15", a15_func, {{0, {{3, 3}, {2, 2}}}, {1, {{3, 2}, {2, 1}}}}, tie(*ch16, *ch29), *a15_detectorsig, tie( *ch30, *ch14));
        auto a16 = SADF::make_kernelMN("a16", a16_func, {{0, {{1, 1}, {2}}}, {1, {{3, 2}, {2}}}}, tie(*ch31), *a16_detectorsig, tie( *ch24, *ch15));
        auto a17 = SADF::make_kernelMN("a17", a17_func, {{0, {{2}, {3}}}, {1, {{2}, {3}}}}, tie(*ch17), *a17_detectorsig, tie( *ch16));
        auto a18 = SADF::make_kernelMN("a18", a18_func, {{0, {{2, 3}, {3, 1}}}, {1, {{2, 3}, {3, 1}}}}, tie(*ch23, *ch21), *a18_detectorsig, tie( *ch17, *ch23_delaysig));
        auto a19 = SADF::make_kernelMN("a19", a19_func, {{0, {{2, 3}, {3, 3}}}, {1, {{2, 3}, {3, 3}}}}, tie(*ch18, *ch26), *a19_detectorsig, tie( *ch22, *ch21));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{1, 2, 1, 2, 3, 1, 1, 1, 3, 1, 2, 2, 1, 2, 1, 2, 1, 2, 3, 1}},{1,{2, 1, 2, 1, 3, 1, 1, 2, 2, 1, 1, 2, 3, 2, 2, 2, 2, 2, 3, 1}}}, 1, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig, *a10_detectorsig, *a11_detectorsig, *a12_detectorsig, *a13_detectorsig, *a14_detectorsig, *a15_detectorsig, *a16_detectorsig, *a17_detectorsig, *a18_detectorsig, *a19_detectorsig), tie());
    }
};
