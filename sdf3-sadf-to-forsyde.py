...
The script takes as input the path to the SADF model and its repeatition vector file and the path to the output file.
...
def sdf3_to_forsyde(inproot, rv):
    ...
    ET.SubElement(outpc, 'argument', {'name': 'init_sc', 'value': '{}'.format(inproot.find('applicationGraph/fsm').attrib['initialstate'])[1:]})
