...
void a1_func(tuple<vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a4_func(tuple<vector<array<int,2>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a7_func(tuple<vector<array<int,2>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>, vector<array<int,2>>, vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
        case 0: {
            for(j=0;j<18;j++)
...
void a9_func(tuple<vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,4>>, vector<array<int,2>>, vector<array<int,1>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
        case 0: {
            for(j=0;j<19;j++)
...
void a11_func(tuple<vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
...
void a15_func(tuple<vector<array<int,2>>, vector<array<int,2>>, vector<array<int,2>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{1, 1, 2, 2, 1, 1, 1, 2, 2, 3, 2, 3, 3, 1, 2, 2, 2, 2, 1, 2}},{1,{1, 1, 2, 2, 2, 1, 1, 2, 2, 1, 2, 2, 1, 2, 3, 2, 2, 2, 2, 2}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch27_delaysig = new SADF::signal<array<int,1>>("ch27_delaysig", 16);
        auto ch29_delaysig = new SADF::signal<array<int,2>>("ch29_delaysig", 16);
        auto ch0_delay = SADF::make_delayn("ch0_delay", array<int,3>{}, 1, *ch0_delaysig, *ch0);
        auto ch7_delay = SADF::make_delayn("ch7_delay", array<int,3>{}, 4, *ch7_delaysig, *ch7);
        auto ch27_delay = SADF::make_delayn("ch27_delay", array<int,1>{}, 4, *ch27_delaysig, *ch27);
        auto ch29_delay = SADF::make_delayn("ch29_delay", array<int,2>{}, 1, *ch29_delaysig, *ch29);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{1}, {2, 2}}}, {1, {{1}, {2, 3}}}}, tie(*ch2, *ch20), *a0_detectorsig, tie( *ch0_delaysig));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{2}, {1, 1}}}, {1, {{2}, {1, 1}}}}, tie(*ch4, *ch0), *a1_detectorsig, tie( *ch1));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{1}, {1}}}, {1, {{1}, {1}}}}, tie(*ch1), *a2_detectorsig, tie( *ch5));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{1}, {2, 1}}}, {1, {{1}, {3, 2}}}}, tie(*ch32, *ch3), *a3_detectorsig, tie( *ch2));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{2}, {2, 3}}}, {1, {{2}, {3, 1}}}}, tie(*ch25, *ch11), *a4_detectorsig, tie( *ch3));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{2, 1}, {1, 3}}}, {1, {{2, 1}, {1, 1}}}}, tie(*ch29, *ch8), *a5_detectorsig, tie( *ch21, *ch4));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{1, 2}, {2, 2}}}, {1, {{1, 2}, {2, 2}}}}, tie(*ch14, *ch5), *a6_detectorsig, tie( *ch29_delaysig, *ch6));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{2, 2, 1}, {1, 2}}}, {1, {{2, 3, 2}, {1, 2}}}}, tie(*ch6, *ch19), *a7_detectorsig, tie( *ch7_delaysig, *ch13, *ch17));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{3, 2}, {2}}}, {1, {{1, 2}, {2}}}}, tie(*ch7), *a8_detectorsig, tie( *ch23, *ch31));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{1, 2, 3}, {2}}}, {1, {{1, 2, 2}, {2}}}}, tie(*ch23), *a9_detectorsig, tie( *ch8, *ch9, *ch10));
        auto a10 = SADF::make_kernelMN("a10", a10_func, {{0, {{2, 2}, {3}}}, {1, {{2, 2}, {1}}}}, tie(*ch9), *a10_detectorsig, tie( *ch22, *ch19));
        auto a11 = SADF::make_kernelMN("a11", a11_func, {{0, {{2, 2, 1}, {3}}}, {1, {{2, 2, 2}, {1}}}}, tie(*ch10), *a11_detectorsig, tie( *ch24, *ch33, *ch12));
        auto a12 = SADF::make_kernelMN("a12", a12_func, {{0, {{1}, {1, 2}}}, {1, {{2}, {2, 2}}}}, tie(*ch30, *ch16), *a12_detectorsig, tie( *ch11));
        auto a13 = SADF::make_kernelMN("a13", a13_func, {{0, {{2}, {3}}}, {1, {{2}, {2}}}}, tie(*ch12), *a13_detectorsig, tie( *ch28));
        auto a14 = SADF::make_kernelMN("a14", a14_func, {{0, {{1, 1, 2}, {2, 2}}}, {1, {{2, 1, 2}, {2, 2}}}}, tie(*ch13, *ch15), *a14_detectorsig, tie( *ch25, *ch20, *ch32));
        auto a15 = SADF::make_kernelMN("a15", a15_func, {{0, {{1}, {1, 3, 2, 3}}}, {1, {{1}, {1, 2, 2, 2}}}}, tie(*ch21, *ch33, *ch22, *ch24), *a15_detectorsig, tie( *ch14));
        auto a16 = SADF::make_kernelMN("a16", a16_func, {{0, {{2}, {1, 1}}}, {1, {{3}, {2, 2}}}}, tie(*ch26, *ch28), *a16_detectorsig, tie( *ch15));
        auto a17 = SADF::make_kernelMN("a17", a17_func, {{0, {{3, 2}, {2, 2}}}, {1, {{1, 2}, {2, 2}}}}, tie(*ch18, *ch31), *a17_detectorsig, tie( *ch16, *ch27_delaysig));
        auto a18 = SADF::make_kernelMN("a18", a18_func, {{0, {{3, 2}, {2}}}, {1, {{1, 2}, {2}}}}, tie(*ch17), *a18_detectorsig, tie( *ch30, *ch26));
        auto a19 = SADF::make_kernelMN("a19", a19_func, {{0, {{2}, {2}}}, {1, {{2}, {2}}}}, tie(*ch27), *a19_detectorsig, tie( *ch18));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{1, 1, 2, 2, 1, 1, 1, 2, 2, 3, 2, 3, 3, 1, 2, 2, 2, 2, 1, 2}},{1,{1, 1, 2, 2, 2, 1, 1, 2, 2, 1, 2, 2, 1, 2, 3, 2, 2, 2, 2, 2}}}, 1, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig, *a10_detectorsig, *a11_detectorsig, *a12_detectorsig, *a13_detectorsig, *a14_detectorsig, *a15_detectorsig, *a16_detectorsig, *a17_detectorsig, *a18_detectorsig, *a19_detectorsig), tie());
    }
};
