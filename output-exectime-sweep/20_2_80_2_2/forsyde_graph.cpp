...
void a1_func(tuple<vector<array<int,2>>, vector<array<int,2>>, vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a3_func(tuple<vector<array<int,2>>, vector<array<int,2>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a14_func(tuple<vector<array<int,4>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a15_func(tuple<vector<array<int,2>>, vector<array<int,2>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a16_func(tuple<vector<array<int,4>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>, vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a19_func(tuple<vector<array<int,3>>, vector<array<int,2>>, vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{3, 1, 1, 1, 3, 2, 2, 2, 3, 2, 1, 2, 1, 2, 1, 1, 2, 1, 3, 1}},{1,{3, 1, 3, 1, 1, 1, 2, 2, 3, 3, 1, 1, 1, 2, 1, 1, 2, 1, 3, 2}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch2_delay = SADF::make_delayn("ch2_delay", array<int,2>{}, 1, *ch2_delaysig, *ch2);
        ...
        auto ch16_delay = SADF::make_delayn("ch16_delay", array<int,2>{}, 1, *ch16_delaysig, *ch16);
        auto ch17_delay = SADF::make_delayn("ch17_delay", array<int,3>{}, 3, *ch17_delaysig, *ch17);
        auto ch30_delay = SADF::make_delayn("ch30_delay", array<int,3>{}, 2, *ch30_delaysig, *ch30);
        auto ch32_delay = SADF::make_delayn("ch32_delay", array<int,2>{}, 3, *ch32_delaysig, *ch32);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{2, 1}, {1}}}, {1, {{2, 1}, {1}}}}, tie(*ch9), *a0_detectorsig, tie( *ch5, *ch0));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{1}, {2, 1, 1, 3}}}, {1, {{1}, {2, 1, 3, 3}}}}, tie(*ch6, *ch14, *ch1, *ch0), *a1_detectorsig, tie( *ch2_delaysig));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{1, 1}, {3}}}, {1, {{1, 1}, {1}}}}, tie(*ch3), *a2_detectorsig, tie( *ch28, *ch1));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{2, 2}, {1, 3, 3}}}, {1, {{1, 1}, {1, 3, 3}}}}, tie(*ch2, *ch32, *ch7), *a3_detectorsig, tie( *ch10, *ch4));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{1}, {2}}}, {1, {{3}, {3}}}}, tie(*ch8), *a4_detectorsig, tie( *ch3));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{1, 3}, {1}}}, {1, {{1, 3}, {1}}}}, tie(*ch4), *a5_detectorsig, tie( *ch20, *ch24));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{1}, {3, 2}}}, {1, {{2}, {3, 2}}}}, tie(*ch5, *ch12), *a6_detectorsig, tie( *ch18));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{2, 1}, {1, 1}}}, {1, {{2, 1}, {1, 1}}}}, tie(*ch11, *ch13), *a7_detectorsig, tie( *ch23, *ch6_delaysig));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{1, 1}, {2}}}, {1, {{1, 1}, {3}}}}, tie(*ch25), *a8_detectorsig, tie( *ch7_delaysig, *ch32_delaysig));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{3, 3}, {2}}}, {1, {{3, 1}, {2}}}}, tie(*ch15), *a9_detectorsig, tie( *ch25, *ch8));
        auto a10 = SADF::make_kernelMN("a10", a10_func, {{0, {{3, 1}, {1}}}, {1, {{3, 1}, {1}}}}, tie(*ch19), *a10_detectorsig, tie( *ch9_delaysig, *ch16_delaysig));
        auto a11 = SADF::make_kernelMN("a11", a11_func, {{0, {{1, 2}, {1}}}, {1, {{2, 2}, {1}}}}, tie(*ch10), *a11_detectorsig, tie( *ch26, *ch22));
        auto a12 = SADF::make_kernelMN("a12", a12_func, {{0, {{2}, {2}}}, {1, {{2}, {2}}}}, tie(*ch30), *a12_detectorsig, tie( *ch11));
        auto a13 = SADF::make_kernelMN("a13", a13_func, {{0, {{2, 1}, {2, 2}}}, {1, {{2, 2}, {2, 1}}}}, tie(*ch23, *ch22), *a13_detectorsig, tie( *ch12_delaysig, *ch27));
        auto a14 = SADF::make_kernelMN("a14", a14_func, {{0, {{2}, {2}}}, {1, {{2}, {1}}}}, tie(*ch20), *a14_detectorsig, tie( *ch13));
        auto a15 = SADF::make_kernelMN("a15", a15_func, {{0, {{1, 1, 3}, {1, 3, 1}}}, {1, {{1, 1, 3}, {3, 3, 1}}}}, tie(*ch28, *ch31, *ch21), *a15_detectorsig, tie( *ch14, *ch19, *ch17_delaysig));
        auto a16 = SADF::make_kernelMN("a16", a16_func, {{0, {{1, 2}, {1}}}, {1, {{1, 3}, {2}}}}, tie(*ch29), *a16_detectorsig, tie( *ch30_delaysig, *ch15));
        auto a17 = SADF::make_kernelMN("a17", a17_func, {{0, {{1}, {1}}}, {1, {{1}, {1}}}}, tie(*ch16), *a17_detectorsig, tie( *ch21));
        auto a18 = SADF::make_kernelMN("a18", a18_func, {{0, {{1}, {2, 1}}}, {1, {{1}, {1, 1}}}}, tie(*ch24, *ch17), *a18_detectorsig, tie( *ch31));
        auto a19 = SADF::make_kernelMN("a19", a19_func, {{0, {{2}, {2, 2, 2}}}, {1, {{2}, {1, 2, 2}}}}, tie(*ch26, *ch18, *ch27), *a19_detectorsig, tie( *ch29));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{3, 1, 1, 1, 3, 2, 2, 2, 3, 2, 1, 2, 1, 2, 1, 1, 2, 1, 3, 1}},{1,{3, 1, 3, 1, 1, 1, 2, 2, 3, 3, 1, 1, 1, 2, 1, 1, 2, 1, 3, 2}}}, 1, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig, *a10_detectorsig, *a11_detectorsig, *a12_detectorsig, *a13_detectorsig, *a14_detectorsig, *a15_detectorsig, *a16_detectorsig, *a17_detectorsig, *a18_detectorsig, *a19_detectorsig), tie());
    }
};
