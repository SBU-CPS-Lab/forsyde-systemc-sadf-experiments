...
void a2_func(tuple<vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a6_func(tuple<vector<array<int,1>>, vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
...
void a7_func(tuple<vector<array<int,3>>, vector<array<int,3>>, vector<array<int,4>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>, vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a11_func(tuple<vector<array<int,3>>, vector<array<int,2>>, vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>, vector<array<int,1>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a13_func(tuple<vector<array<int,2>>, vector<array<int,2>>, vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>, vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a14_func(tuple<vector<array<int,1>>, vector<array<int,2>>, vector<array<int,2>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>, vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a16_func(tuple<vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,1>>, vector<array<int,2>>, vector<array<int,1>>, vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
        case 0: {
            for(j=0;j<19;j++)
...
void a19_func(tuple<vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{1, 2, 2, 2, 2, 2, 3, 1, 2, 1, 2, 3, 1, 1, 2, 2, 2, 3, 2, 2}},{1,{2, 2, 2, 1, 1, 2, 3, 1, 2, 1, 2, 3, 1, 1, 2, 2, 2, 2, 2, 2}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch20_delaysig = new SADF::signal<array<int,4>>("ch20_delaysig", 16);
        ...
        auto ch5_delay = SADF::make_delayn("ch5_delay", array<int,2>{}, 6, *ch5_delaysig, *ch5);
        auto ch6_delay = SADF::make_delayn("ch6_delay", array<int,2>{}, 2, *ch6_delaysig, *ch6);
        auto ch12_delay = SADF::make_delayn("ch12_delay", array<int,2>{}, 2, *ch12_delaysig, *ch12);
        auto ch13_delay = SADF::make_delayn("ch13_delay", array<int,2>{}, 6, *ch13_delaysig, *ch13);
        auto ch17_delay = SADF::make_delayn("ch17_delay", array<int,2>{}, 2, *ch17_delaysig, *ch17);
        auto ch19_delay = SADF::make_delayn("ch19_delay", array<int,1>{}, 2, *ch19_delaysig, *ch19);
        auto ch20_delay = SADF::make_delayn("ch20_delay", array<int,4>{}, 1, *ch20_delaysig, *ch20);
        auto ch22_delay = SADF::make_delayn("ch22_delay", array<int,2>{}, 2, *ch22_delaysig, *ch22);
        auto ch30_delay = SADF::make_delayn("ch30_delay", array<int,1>{}, 6, *ch30_delaysig, *ch30);
        auto ch33_delay = SADF::make_delayn("ch33_delay", array<int,1>{}, 4, *ch33_delaysig, *ch33);
        auto ch34_delay = SADF::make_delayn("ch34_delay", array<int,2>{}, 2, *ch34_delaysig, *ch34);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{2, 2}, {2}}}, {1, {{1, 2}, {2}}}}, tie(*ch0), *a0_detectorsig, tie( *ch2, *ch1));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{1}, {1, 2}}}, {1, {{2}, {1, 1}}}}, tie(*ch29, *ch3), *a1_detectorsig, tie( *ch0));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{1, 2, 2}, {1, 1}}}, {1, {{1, 2, 2}, {2, 1}}}}, tie(*ch1, *ch6), *a2_detectorsig, tie( *ch8, *ch32, *ch7));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{3}, {1}}}, {1, {{3}, {2}}}}, tie(*ch2), *a3_detectorsig, tie( *ch26));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{1, 2}, {2}}}, {1, {{1, 2}, {2}}}}, tie(*ch4), *a4_detectorsig, tie( *ch24, *ch3));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{2}, {3}}}, {1, {{1}, {3}}}}, tie(*ch5), *a5_detectorsig, tie( *ch4));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{2}, {3, 2}}}, {1, {{2}, {3, 2}}}}, tie(*ch10, *ch30), *a6_detectorsig, tie( *ch5_delaysig));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{2, 2}, {3, 2, 1}}}, {1, {{2, 2}, {2, 2, 1}}}}, tie(*ch23, *ch25, *ch20), *a7_detectorsig, tie( *ch6_delaysig, *ch22_delaysig));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{1}, {2, 2}}}, {1, {{1}, {2, 2}}}}, tie(*ch9, *ch7), *a8_detectorsig, tie( *ch12_delaysig));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{2, 1}, {2, 3}}}, {1, {{2, 1}, {2, 2}}}}, tie(*ch8, *ch31), *a9_detectorsig, tie( *ch34_delaysig, *ch20_delaysig));
        auto a10 = SADF::make_kernelMN("a10", a10_func, {{0, {{2, 3}, {2}}}, {1, {{2, 3}, {2}}}}, tie(*ch27), *a10_detectorsig, tie( *ch9, *ch30_delaysig));
        auto a11 = SADF::make_kernelMN("a11", a11_func, {{0, {{2, 3}, {1, 2, 2}}}, {1, {{2, 3}, {1, 2, 1}}}}, tie(*ch11, *ch14, *ch26), *a11_detectorsig, tie( *ch13_delaysig, *ch10));
        auto a12 = SADF::make_kernelMN("a12", a12_func, {{0, {{3}, {2}}}, {1, {{3}, {2}}}}, tie(*ch17), *a12_detectorsig, tie( *ch11));
        auto a13 = SADF::make_kernelMN("a13", a13_func, {{0, {{2, 2}, {2, 2, 2}}}, {1, {{2, 2}, {2, 1, 2}}}}, tie(*ch12, *ch24, *ch19), *a13_detectorsig, tie( *ch15, *ch29));
        auto a14 = SADF::make_kernelMN("a14", a14_func, {{0, {{3, 2}, {2, 1, 3, 2}}}, {1, {{2, 2}, {2, 1, 3, 2}}}}, tie(*ch21, *ch22, *ch13, *ch32), *a14_detectorsig, tie( *ch16, *ch18));
        auto a15 = SADF::make_kernelMN("a15", a15_func, {{0, {{1, 3}, {2}}}, {1, {{1, 3}, {2}}}}, tie(*ch33), *a15_detectorsig, tie( *ch25, *ch14));
        auto a16 = SADF::make_kernelMN("a16", a16_func, {{0, {{2, 2, 1, 2}, {1}}}, {1, {{2, 2, 1, 2}, {1}}}}, tie(*ch15), *a16_detectorsig, tie( *ch21, *ch28, *ch19_delaysig, *ch27));
        auto a17 = SADF::make_kernelMN("a17", a17_func, {{0, {{1, 1}, {2}}}, {1, {{1, 1}, {2}}}}, tie(*ch16), *a17_detectorsig, tie( *ch31, *ch23));
        auto a18 = SADF::make_kernelMN("a18", a18_func, {{0, {{1, 2}, {2, 1, 2}}}, {1, {{1, 2}, {2, 1, 2}}}}, tie(*ch28, *ch34, *ch35), *a18_detectorsig, tie( *ch17_delaysig, *ch33_delaysig));
        auto a19 = SADF::make_kernelMN("a19", a19_func, {{0, {{2}, {2}}}, {1, {{2}, {2}}}}, tie(*ch18), *a19_detectorsig, tie( *ch35));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{1, 2, 2, 2, 2, 2, 3, 1, 2, 1, 2, 3, 1, 1, 2, 2, 2, 3, 2, 2}},{1,{2, 2, 2, 1, 1, 2, 3, 1, 2, 1, 2, 3, 1, 1, 2, 2, 2, 2, 2, 2}}}, 1, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig, *a10_detectorsig, *a11_detectorsig, *a12_detectorsig, *a13_detectorsig, *a14_detectorsig, *a15_detectorsig, *a16_detectorsig, *a17_detectorsig, *a18_detectorsig, *a19_detectorsig), tie());
    }
};
