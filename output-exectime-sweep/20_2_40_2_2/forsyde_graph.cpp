...
void a2_func(tuple<vector<array<int,3>>, vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,1>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a3_func(tuple<vector<array<int,1>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a5_func(tuple<vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a9_func(tuple<vector<array<int,2>>, vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a10_func(tuple<vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>, vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a11_func(tuple<vector<array<int,1>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a12_func(tuple<vector<array<int,2>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>, vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a15_func(tuple<vector<array<int,2>>, vector<array<int,3>>, vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a16_func(tuple<vector<array<int,3>>, vector<array<int,2>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a18_func(tuple<vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>, vector<array<int,3>>, vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a19_func(tuple<vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>, vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{2, 3, 3, 1, 2, 2, 2, 1, 1, 2, 2, 2, 3, 4, 3, 3, 3, 2, 3, 1}},{1,{2, 1, 3, 1, 2, 2, 2, 1, 1, 2, 2, 1, 2, 4, 2, 3, 3, 2, 3, 1}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch35 = new SADF::signal<array<int,1>>("ch35", 16);
        ...
        auto ch35_delaysig = new SADF::signal<array<int,1>>("ch35_delaysig", 16);
        auto ch36_delaysig = new SADF::signal<array<int,2>>("ch36_delaysig", 16);
        auto ch2_delay = SADF::make_delayn("ch2_delay", array<int,1>{}, 3, *ch2_delaysig, *ch2);
        auto ch5_delay = SADF::make_delayn("ch5_delay", array<int,3>{}, 4, *ch5_delaysig, *ch5);
        auto ch18_delay = SADF::make_delayn("ch18_delay", array<int,2>{}, 3, *ch18_delaysig, *ch18);
        auto ch19_delay = SADF::make_delayn("ch19_delay", array<int,3>{}, 3, *ch19_delaysig, *ch19);
        auto ch21_delay = SADF::make_delayn("ch21_delay", array<int,3>{}, 6, *ch21_delaysig, *ch21);
        auto ch22_delay = SADF::make_delayn("ch22_delay", array<int,3>{}, 2, *ch22_delaysig, *ch22);
        auto ch23_delay = SADF::make_delayn("ch23_delay", array<int,2>{}, 2, *ch23_delaysig, *ch23);
        auto ch28_delay = SADF::make_delayn("ch28_delay", array<int,3>{}, 9, *ch28_delaysig, *ch28);
        auto ch33_delay = SADF::make_delayn("ch33_delay", array<int,3>{}, 4, *ch33_delaysig, *ch33);
        auto ch35_delay = SADF::make_delayn("ch35_delay", array<int,1>{}, 2, *ch35_delaysig, *ch35);
        auto ch36_delay = SADF::make_delayn("ch36_delay", array<int,2>{}, 12, *ch36_delaysig, *ch36);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{1, 3, 3}, {4}}}, {1, {{1, 1, 3}, {4}}}}, tie(*ch26), *a0_detectorsig, tie( *ch6, *ch0, *ch1));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{2}, {2}}}, {1, {{1}, {2}}}}, tie(*ch0), *a1_detectorsig, tie( *ch20));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{1}, {2, 2, 3}}}, {1, {{1}, {1, 2, 2}}}}, tie(*ch10, *ch1, *ch34), *a2_detectorsig, tie( *ch2_delaysig));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{3, 3, 2}, {3, 3}}}, {1, {{3, 3, 2}, {3, 3}}}}, tie(*ch2, *ch15), *a3_detectorsig, tie( *ch19_delaysig, *ch14, *ch3));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{2, 2, 3}, {1, 2}}}, {1, {{2, 2, 3}, {1, 2}}}}, tie(*ch3, *ch5), *a4_detectorsig, tie( *ch4, *ch8, *ch25));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{4, 3}, {2, 2}}}, {1, {{4, 3}, {2, 2}}}}, tie(*ch33, *ch4), *a5_detectorsig, tie( *ch12, *ch21_delaysig));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{2}, {1}}}, {1, {{2}, {1}}}}, tie(*ch7), *a6_detectorsig, tie( *ch5_delaysig));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{2}, {2, 3}}}, {1, {{2}, {2, 3}}}}, tie(*ch6, *ch29), *a7_detectorsig, tie( *ch35_delaysig));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{2}, {3, 2}}}, {1, {{2}, {2, 2}}}}, tie(*ch13, *ch23), *a8_detectorsig, tie( *ch7));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{2, 1}, {3, 2, 2}}}, {1, {{2, 1}, {3, 2, 2}}}}, tie(*ch17, *ch8, *ch9), *a9_detectorsig, tie( *ch33_delaysig, *ch23_delaysig));
        auto a10 = SADF::make_kernelMN("a10", a10_func, {{0, {{3, 2}, {1}}}, {1, {{2, 2}, {1}}}}, tie(*ch35), *a10_detectorsig, tie( *ch11, *ch9));
        auto a11 = SADF::make_kernelMN("a11", a11_func, {{0, {{3}, {3, 3}}}, {1, {{3}, {1, 3}}}}, tie(*ch20, *ch31), *a11_detectorsig, tie( *ch10));
        auto a12 = SADF::make_kernelMN("a12", a12_func, {{0, {{3, 2}, {2, 3}}}, {1, {{2, 2}, {2, 3}}}}, tie(*ch11, *ch27), *a12_detectorsig, tie( *ch24, *ch16));
        auto a13 = SADF::make_kernelMN("a13", a13_func, {{0, {{2, 3}, {2}}}, {1, {{2, 3}, {2}}}}, tie(*ch12), *a13_detectorsig, tie( *ch26, *ch36_delaysig));
        auto a14 = SADF::make_kernelMN("a14", a14_func, {{0, {{3, 1}, {3}}}, {1, {{3, 1}, {2}}}}, tie(*ch24), *a14_detectorsig, tie( *ch34, *ch13));
        auto a15 = SADF::make_kernelMN("a15", a15_func, {{0, {{2, 3, 3}, {1, 3, 2, 1}}}, {1, {{1, 3, 2}, {1, 3, 2, 1}}}}, tie(*ch18, *ch28, *ch25, *ch14), *a15_detectorsig, tie( *ch31, *ch28_delaysig, *ch27));
        auto a16 = SADF::make_kernelMN("a16", a16_func, {{0, {{1}, {1, 4, 3}}}, {1, {{1}, {1, 4, 3}}}}, tie(*ch19, *ch36, *ch30), *a16_detectorsig, tie( *ch15));
        auto a17 = SADF::make_kernelMN("a17", a17_func, {{0, {{1}, {3, 1}}}, {1, {{1}, {2, 1}}}}, tie(*ch16, *ch22), *a17_detectorsig, tie( *ch32));
        auto a18 = SADF::make_kernelMN("a18", a18_func, {{0, {{1, 3, 2}, {2}}}, {1, {{1, 3, 2}, {2}}}}, tie(*ch21), *a18_detectorsig, tie( *ch29, *ch30, *ch17));
        auto a19 = SADF::make_kernelMN("a19", a19_func, {{0, {{2, 3}, {2}}}, {1, {{2, 3}, {2}}}}, tie(*ch32), *a19_detectorsig, tie( *ch22_delaysig, *ch18_delaysig));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{2, 3, 3, 1, 2, 2, 2, 1, 1, 2, 2, 2, 3, 4, 3, 3, 3, 2, 3, 1}},{1,{2, 1, 3, 1, 2, 2, 2, 1, 1, 2, 2, 1, 2, 4, 2, 3, 3, 2, 3, 1}}}, 0, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig, *a10_detectorsig, *a11_detectorsig, *a12_detectorsig, *a13_detectorsig, *a14_detectorsig, *a15_detectorsig, *a16_detectorsig, *a17_detectorsig, *a18_detectorsig, *a19_detectorsig), tie());
    }
};
