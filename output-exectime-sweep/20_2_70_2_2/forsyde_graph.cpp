...
void a0_func(tuple<vector<array<int,3>>, vector<array<int,1>>>& out,
...
void a2_func(tuple<vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a4_func(tuple<vector<array<int,3>>, vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
...
void a5_func(tuple<vector<array<int,2>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a6_func(tuple<vector<array<int,1>>, vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a8_func(tuple<vector<array<int,1>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>, vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a12_func(tuple<vector<array<int,2>>, vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
...
void a13_func(tuple<vector<array<int,3>>, vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
...
void a16_func(tuple<vector<array<int,2>>, vector<array<int,1>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a19_func(tuple<vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{1, 1, 2, 2, 2, 1, 3, 2, 2, 1, 3, 3, 2, 1, 2, 1, 1, 2, 1, 3}},{1,{1, 1, 2, 1, 2, 1, 3, 2, 2, 1, 3, 3, 2, 1, 1, 1, 1, 3, 4, 1}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch1_delaysig = new SADF::signal<array<int,3>>("ch1_delaysig", 16);
        ...
        auto ch1_delay = SADF::make_delayn("ch1_delay", array<int,3>{}, 2, *ch1_delaysig, *ch1);
        auto ch8_delay = SADF::make_delayn("ch8_delay", array<int,2>{}, 1, *ch8_delaysig, *ch8);
        auto ch9_delay = SADF::make_delayn("ch9_delay", array<int,3>{}, 3, *ch9_delaysig, *ch9);
        auto ch10_delay = SADF::make_delayn("ch10_delay", array<int,3>{}, 6, *ch10_delaysig, *ch10);
        auto ch11_delay = SADF::make_delayn("ch11_delay", array<int,2>{}, 2, *ch11_delaysig, *ch11);
        auto ch12_delay = SADF::make_delayn("ch12_delay", array<int,1>{}, 2, *ch12_delaysig, *ch12);
        auto ch15_delay = SADF::make_delayn("ch15_delay", array<int,2>{}, 2, *ch15_delaysig, *ch15);
        auto ch23_delay = SADF::make_delayn("ch23_delay", array<int,3>{}, 2, *ch23_delaysig, *ch23);
        auto ch29_delay = SADF::make_delayn("ch29_delay", array<int,2>{}, 4, *ch29_delaysig, *ch29);
        auto ch33_delay = SADF::make_delayn("ch33_delay", array<int,2>{}, 3, *ch33_delaysig, *ch33);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{3, 2, 1}, {2, 1}}}, {1, {{3, 2, 4}, {2, 1}}}}, tie(*ch1, *ch0), *a0_detectorsig, tie( *ch34, *ch3, *ch22));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{1}, {3}}}, {1, {{1}, {3}}}}, tie(*ch9), *a1_detectorsig, tie( *ch0));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{1}, {2, 2}}}, {1, {{1}, {1, 1}}}}, tie(*ch13, *ch2), *a2_detectorsig, tie( *ch1_delaysig));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{2}, {2}}}, {1, {{2}, {2}}}}, tie(*ch6), *a3_detectorsig, tie( *ch2));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{3, 1}, {1, 1}}}, {1, {{1, 1}, {1, 1}}}}, tie(*ch3, *ch12), *a4_detectorsig, tie( *ch32, *ch4));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{1, 3, 2}, {2, 2}}}, {1, {{1, 3, 2}, {2, 2}}}}, tie(*ch11, *ch4), *a5_detectorsig, tie( *ch8_delaysig, *ch5, *ch24));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{2}, {1, 2, 1}}}, {1, {{2}, {1, 2, 1}}}}, tie(*ch5, *ch7, *ch33), *a6_detectorsig, tie( *ch31));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{1, 2}, {3, 1}}}, {1, {{1, 1}, {3, 1}}}}, tie(*ch31, *ch27), *a7_detectorsig, tie( *ch15_delaysig, *ch6));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{1, 3}, {1, 3}}}, {1, {{1, 3}, {4, 3}}}}, tie(*ch26, *ch10), *a8_detectorsig, tie( *ch23_delaysig, *ch7));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{3}, {1}}}, {1, {{1}, {1}}}}, tie(*ch8), *a9_detectorsig, tie( *ch30));
        auto a10 = SADF::make_kernelMN("a10", a10_func, {{0, {{1, 1}, {3}}}, {1, {{1, 1}, {1}}}}, tie(*ch19), *a10_detectorsig, tie( *ch9_delaysig, *ch20));
        auto a11 = SADF::make_kernelMN("a11", a11_func, {{0, {{2}, {1, 1}}}, {1, {{2}, {1, 1}}}}, tie(*ch21, *ch34), *a11_detectorsig, tie( *ch10_delaysig));
        auto a12 = SADF::make_kernelMN("a12", a12_func, {{0, {{1, 2}, {2, 1}}}, {1, {{1, 2}, {2, 1}}}}, tie(*ch29, *ch24), *a12_detectorsig, tie( *ch11_delaysig, *ch29_delaysig));
        auto a13 = SADF::make_kernelMN("a13", a13_func, {{0, {{2, 3}, {2, 1}}}, {1, {{2, 3}, {2, 1}}}}, tie(*ch23, *ch14), *a13_detectorsig, tie( *ch12_delaysig, *ch33_delaysig));
        auto a14 = SADF::make_kernelMN("a14", a14_func, {{0, {{2}, {2}}}, {1, {{2}, {3}}}}, tie(*ch16), *a14_detectorsig, tie( *ch13));
        auto a15 = SADF::make_kernelMN("a15", a15_func, {{0, {{1, 3}, {3}}}, {1, {{1, 3}, {1}}}}, tie(*ch18), *a15_detectorsig, tie( *ch14, *ch21));
        auto a16 = SADF::make_kernelMN("a16", a16_func, {{0, {{2, 2}, {2, 3, 1}}}, {1, {{3, 2}, {2, 3, 4}}}}, tie(*ch15, *ch20, *ch17), *a16_detectorsig, tie( *ch25, *ch27));
        auto a17 = SADF::make_kernelMN("a17", a17_func, {{0, {{2}, {1}}}, {1, {{1}, {1}}}}, tie(*ch25), *a17_detectorsig, tie( *ch16));
        auto a18 = SADF::make_kernelMN("a18", a18_func, {{0, {{2, 1}, {3, 1}}}, {1, {{2, 1}, {1, 1}}}}, tie(*ch28, *ch22), *a18_detectorsig, tie( *ch26, *ch17));
        auto a19 = SADF::make_kernelMN("a19", a19_func, {{0, {{1, 3, 1}, {2, 1}}}, {1, {{4, 3, 1}, {2, 1}}}}, tie(*ch32, *ch30), *a19_detectorsig, tie( *ch28, *ch19, *ch18));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{1, 1, 2, 2, 2, 1, 3, 2, 2, 1, 3, 3, 2, 1, 2, 1, 1, 2, 1, 3}},{1,{1, 1, 2, 1, 2, 1, 3, 2, 2, 1, 3, 3, 2, 1, 1, 1, 1, 3, 4, 1}}}, 1, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig, *a10_detectorsig, *a11_detectorsig, *a12_detectorsig, *a13_detectorsig, *a14_detectorsig, *a15_detectorsig, *a16_detectorsig, *a17_detectorsig, *a18_detectorsig, *a19_detectorsig), tie());
    }
};
