...
void a1_func(tuple<vector<array<int,4>>>& out,
    const unsigned int& _scenario_state,
...
void a2_func(tuple<vector<array<int,2>>, vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a5_func(tuple<vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
...
void a9_func(tuple<vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a11_func(tuple<vector<array<int,3>>, vector<array<int,3>>, vector<array<int,2>>, vector<array<int,4>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{2, 2, 1, 1, 1, 2, 2, 1, 2, 2, 1, 1, 2, 1, 1, 2, 2, 1, 3, 2}},{1,{4, 1, 1, 1, 2, 2, 2, 1, 2, 2, 1, 1, 2, 1, 2, 1, 1, 1, 3, 1}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch16_delaysig = new SADF::signal<array<int,1>>("ch16_delaysig", 16);
        ...
        auto ch16_delay = SADF::make_delayn("ch16_delay", array<int,1>{}, 2, *ch16_delaysig, *ch16);
        auto ch22_delay = SADF::make_delayn("ch22_delay", array<int,3>{}, 6, *ch22_delaysig, *ch22);
        auto ch26_delay = SADF::make_delayn("ch26_delay", array<int,2>{}, 2, *ch26_delaysig, *ch26);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{1, 1}, {2}}}, {1, {{1, 1}, {1}}}}, tie(*ch0), *a0_detectorsig, tie( *ch28, *ch1));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{2}, {2}}}, {1, {{4}, {2}}}}, tie(*ch4), *a1_detectorsig, tie( *ch0));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{1}, {1, 1, 2}}}, {1, {{1}, {1, 1, 4}}}}, tie(*ch12, *ch2, *ch1), *a2_detectorsig, tie( *ch6));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{2, 1}, {1}}}, {1, {{2, 1}, {2}}}}, tie(*ch3), *a3_detectorsig, tie( *ch5, *ch2));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{1}, {2}}}, {1, {{1}, {2}}}}, tie(*ch24), *a4_detectorsig, tie( *ch3));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{2, 1}, {1}}}, {1, {{1, 2}, {1}}}}, tie(*ch16), *a5_detectorsig, tie( *ch4, *ch24));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{2}, {1, 2}}}, {1, {{2}, {1, 2}}}}, tie(*ch5, *ch7), *a6_detectorsig, tie( *ch8));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{2, 1}, {3, 1}}}, {1, {{2, 1}, {3, 1}}}}, tie(*ch20, *ch6), *a7_detectorsig, tie( *ch21, *ch27));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{1, 2}, {1}}}, {1, {{1, 2}, {1}}}}, tie(*ch21), *a8_detectorsig, tie( *ch9, *ch7));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{3, 1}, {2, 3}}}, {1, {{3, 2}, {2, 3}}}}, tie(*ch8, *ch17), *a9_detectorsig, tie( *ch22_delaysig, *ch13));
        auto a10 = SADF::make_kernelMN("a10", a10_func, {{0, {{1}, {2}}}, {1, {{1}, {2}}}}, tie(*ch9), *a10_detectorsig, tie( *ch10));
        auto a11 = SADF::make_kernelMN("a11", a11_func, {{0, {{2}, {2, 1, 1, 2}}}, {1, {{2}, {2, 1, 1, 1}}}}, tie(*ch11, *ch27, *ch10, *ch19), *a11_detectorsig, tie( *ch26_delaysig));
        auto a12 = SADF::make_kernelMN("a12", a12_func, {{0, {{1, 1}, {1}}}, {1, {{1, 1}, {1}}}}, tie(*ch26), *a12_detectorsig, tie( *ch23, *ch11));
        auto a13 = SADF::make_kernelMN("a13", a13_func, {{0, {{1}, {2}}}, {1, {{1}, {4}}}}, tie(*ch28), *a13_detectorsig, tie( *ch12_delaysig));
        auto a14 = SADF::make_kernelMN("a14", a14_func, {{0, {{2}, {2}}}, {1, {{1}, {2}}}}, tie(*ch13), *a14_detectorsig, tie( *ch14));
        auto a15 = SADF::make_kernelMN("a15", a15_func, {{0, {{2}, {1}}}, {1, {{1}, {2}}}}, tie(*ch14), *a15_detectorsig, tie( *ch15));
        auto a16 = SADF::make_kernelMN("a16", a16_func, {{0, {{2}, {2}}}, {1, {{1}, {1}}}}, tie(*ch15), *a16_detectorsig, tie( *ch18));
        auto a17 = SADF::make_kernelMN("a17", a17_func, {{0, {{2}, {3, 2}}}, {1, {{2}, {3, 2}}}}, tie(*ch25, *ch23), *a17_detectorsig, tie( *ch16_delaysig));
        auto a18 = SADF::make_kernelMN("a18", a18_func, {{0, {{1, 2, 1}, {2}}}, {1, {{1, 2, 1}, {2}}}}, tie(*ch22), *a18_detectorsig, tie( *ch20, *ch17, *ch25));
        auto a19 = SADF::make_kernelMN("a19", a19_func, {{0, {{1}, {2}}}, {1, {{1}, {1}}}}, tie(*ch18), *a19_detectorsig, tie( *ch19));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{2, 2, 1, 1, 1, 2, 2, 1, 2, 2, 1, 1, 2, 1, 1, 2, 2, 1, 3, 2}},{1,{4, 1, 1, 1, 2, 2, 2, 1, 2, 2, 1, 1, 2, 1, 2, 1, 1, 1, 3, 1}}}, 0, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig, *a10_detectorsig, *a11_detectorsig, *a12_detectorsig, *a13_detectorsig, *a14_detectorsig, *a15_detectorsig, *a16_detectorsig, *a17_detectorsig, *a18_detectorsig, *a19_detectorsig), tie());
    }
};
