...
void a1_func(tuple<vector<array<int,4>>, vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a2_func(tuple<vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
...
void a3_func(tuple<vector<array<int,1>>, vector<array<int,2>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a4_func(tuple<vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a6_func(tuple<vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a7_func(tuple<vector<array<int,3>>, vector<array<int,4>>>& out,
    const unsigned int& _scenario_state,
...
void a8_func(tuple<vector<array<int,2>>, vector<array<int,1>>>& out,
    const unsigned int& _scenario_state,
...
void a11_func(tuple<vector<array<int,2>>, vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a13_func(tuple<vector<array<int,4>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a14_func(tuple<vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,1>>, vector<array<int,3>>, vector<array<int,4>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
        case 0: {
            for(j=0;j<20;j++)
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{1, 3, 3, 2, 2, 2, 1, 1, 1, 2, 3, 2, 1, 1, 3}},{1,{1, 3, 2, 3, 2, 2, 1, 1, 1, 3, 3, 2, 1, 1, 3}}};

void detectorkss_func(tuple<vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>, vector<unsigned int>>& out,
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch16 = new SADF::signal<array<int,4>>("ch16", 16);
        ...
        auto ch5_delay = SADF::make_delayn("ch5_delay", array<int,2>{}, 3, *ch5_delaysig, *ch5);
        auto ch14_delay = SADF::make_delayn("ch14_delay", array<int,1>{}, 1, *ch14_delaysig, *ch14);
        ...
        auto ch18_delay = SADF::make_delayn("ch18_delay", array<int,2>{}, 6, *ch18_delaysig, *ch18);
        auto ch19_delay = SADF::make_delayn("ch19_delay", array<int,2>{}, 3, *ch19_delaysig, *ch19);
        auto ch24_delay = SADF::make_delayn("ch24_delay", array<int,2>{}, 1, *ch24_delaysig, *ch24);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{3, 2}, {1}}}, {1, {{3, 3}, {1}}}}, tie(*ch7), *a0_detectorsig, tie( *ch0, *ch2));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{1, 2, 1}, {3, 1, 2}}}, {1, {{1, 2, 1}, {2, 1, 3}}}}, tie(*ch1, *ch0, *ch26), *a1_detectorsig, tie( *ch11, *ch18_delaysig, *ch5_delaysig));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{3}, {2}}}, {1, {{3}, {2}}}}, tie(*ch3), *a2_detectorsig, tie( *ch1));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{3}, {2, 1, 1}}}, {1, {{3}, {3, 1, 1}}}}, tie(*ch8, *ch6, *ch2), *a3_detectorsig, tie( *ch26));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{1, 3}, {3, 2}}}, {1, {{1, 2}, {3, 2}}}}, tie(*ch22, *ch4), *a4_detectorsig, tie( *ch15_delaysig, *ch3));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{2}, {3, 3}}}, {1, {{2}, {3, 3}}}}, tie(*ch18, *ch27), *a5_detectorsig, tie( *ch4));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{3}, {2, 3}}}, {1, {{3}, {2, 3}}}}, tie(*ch15, *ch5), *a6_detectorsig, tie( *ch9));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{3, 2, 2}, {2, 3}}}, {1, {{3, 3, 3}, {2, 3}}}}, tie(*ch20, *ch16), *a7_detectorsig, tie( *ch19_delaysig, *ch6, *ch23));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{1}, {1, 1}}}, {1, {{1}, {1, 1}}}}, tie(*ch24, *ch14), *a8_detectorsig, tie( *ch7));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{2, 1}, {1}}}, {1, {{3, 1}, {1}}}}, tie(*ch23), *a9_detectorsig, tie( *ch8, *ch12));
        auto a10 = SADF::make_kernelMN("a10", a10_func, {{0, {{2, 2, 2}, {1}}}, {1, {{2, 2, 2}, {1}}}}, tie(*ch9), *a10_detectorsig, tie( *ch22, *ch10, *ch27));
        auto a11 = SADF::make_kernelMN("a11", a11_func, {{0, {{1}, {3, 3, 1}}}, {1, {{1}, {3, 3, 1}}}}, tie(*ch10, *ch13, *ch17), *a11_detectorsig, tie( *ch20));
        auto a12 = SADF::make_kernelMN("a12", a12_func, {{0, {{2, 1}, {3, 3}}}, {1, {{2, 1}, {3, 3}}}}, tie(*ch21, *ch11), *a12_detectorsig, tie( *ch17_delaysig, *ch25));
        auto a13 = SADF::make_kernelMN("a13", a13_func, {{0, {{1, 1}, {1, 2}}}, {1, {{1, 1}, {1, 3}}}}, tie(*ch25, *ch12), *a13_detectorsig, tie( *ch14_delaysig, *ch24_delaysig));
        auto a14 = SADF::make_kernelMN("a14", a14_func, {{0, {{1, 2, 1}, {1}}}, {1, {{1, 2, 1}, {1}}}}, tie(*ch19), *a14_detectorsig, tie( *ch21, *ch13, *ch16));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{1, 3, 3, 2, 2, 2, 1, 1, 1, 2, 3, 2, 1, 1, 3}},{1,{1, 3, 2, 3, 2, 2, 1, 1, 1, 3, 3, 2, 1, 1, 3}}}, 0, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig, *a10_detectorsig, *a11_detectorsig, *a12_detectorsig, *a13_detectorsig, *a14_detectorsig), tie());
    }
};
