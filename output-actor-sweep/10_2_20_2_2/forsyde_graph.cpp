...
void a2_func(tuple<vector<array<int,3>>, vector<array<int,1>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a5_func(tuple<vector<array<int,3>>, vector<array<int,1>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{1, 2, 2, 1, 2, 1, 2, 2, 2, 1}},{1,{1, 2, 2, 1, 2, 1, 2, 2, 2, 1}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch6_delay = SADF::make_delayn("ch6_delay", array<int,2>{}, 4, *ch6_delaysig, *ch6);
        auto ch14_delay = SADF::make_delayn("ch14_delay", array<int,2>{}, 2, *ch14_delaysig, *ch14);
        auto ch15_delay = SADF::make_delayn("ch15_delay", array<int,1>{}, 4, *ch15_delaysig, *ch15);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{2, 1}, {2, 2}}}, {1, {{2, 1}, {2, 2}}}}, tie(*ch12, *ch1), *a0_detectorsig, tie( *ch0_delaysig, *ch2));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{1, 2}, {1}}}, {1, {{1, 2}, {1}}}}, tie(*ch0), *a1_detectorsig, tie( *ch13, *ch7));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{1, 2}, {2, 1, 1}}}, {1, {{1, 2}, {2, 1, 1}}}}, tie(*ch3, *ch18, *ch10), *a2_detectorsig, tie( *ch1_delaysig, *ch15_delaysig));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{2, 1, 1}, {1, 1}}}, {1, {{2, 1, 1}, {1, 1}}}}, tie(*ch11, *ch2), *a3_detectorsig, tie( *ch10, *ch4, *ch17));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{2}, {2}}}, {1, {{2}, {2}}}}, tie(*ch15), *a4_detectorsig, tie( *ch3));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{2, 2}, {1, 1, 2}}}, {1, {{2, 2}, {1, 1, 2}}}}, tie(*ch4, *ch17, *ch5), *a5_detectorsig, tie( *ch18, *ch14_delaysig));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{2, 1}, {1, 2}}}, {1, {{2, 1}, {1, 2}}}}, tie(*ch8, *ch9), *a6_detectorsig, tie( *ch6_delaysig, *ch5));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{2, 1}, {1, 2}}}, {1, {{2, 1}, {1, 2}}}}, tie(*ch14, *ch6), *a7_detectorsig, tie( *ch9, *ch16));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{1}, {2}}}, {1, {{1}, {2}}}}, tie(*ch7), *a8_detectorsig, tie( *ch12));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{2, 1}, {2, 2}}}, {1, {{2, 1}, {2, 2}}}}, tie(*ch13, *ch16), *a9_detectorsig, tie( *ch8, *ch11));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{1, 2, 2, 1, 2, 1, 2, 2, 2, 1}},{1,{1, 2, 2, 1, 2, 1, 2, 2, 2, 1}}}, 0, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig), tie());
    }
};
