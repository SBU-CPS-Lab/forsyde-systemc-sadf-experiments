...
void a0_func(tuple<vector<array<int,3>>, vector<array<int,3>>, vector<array<int,3>>>& out,
...
void a3_func(tuple<vector<array<int,4>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a4_func(tuple<vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>, vector<array<int,4>>, vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
        case 0: {
            for(j=0;j<19;j++)
...
void a5_func(tuple<vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void detectorcds_func(int& new_scenario,
    ...
    switch(previous_scenario) {
        case 0: {
            unsigned int trans_dests[] = {0, 1, 2, 3, 4, 5, 6, 7};
            new_scenario = trans_dests[rand()%8];
            break;
        }
        case 1: {
            unsigned int trans_dests[] = {0, 1, 2, 3, 4, 5, 6, 7};
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{1, 1, 1, 1, 3, 2, 2, 1, 1, 3}},{1,{1, 1, 1, 1, 3, 2, 2, 1, 1, 2}},{2,{1, 1, 1, 1, 3, 2, 2, 1, 1, 2}},{3,{1, 1, 1, 1, 3, 2, 2, 1, 1, 1}},{4,{1, 1, 1, 1, 3, 2, 2, 1, 1, 2}},{5,{1, 1, 1, 1, 3, 2, 2, 1, 1, 1}},{6,{1, 1, 1, 1, 3, 2, 2, 1, 1, 2}},{7,{1, 1, 1, 1, 3, 2, 2, 1, 1, 1}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch7_delay = SADF::make_delayn("ch7_delay", array<int,3>{}, 1, *ch7_delaysig, *ch7);
        auto ch10_delay = SADF::make_delayn("ch10_delay", array<int,2>{}, 4, *ch10_delaysig, *ch10);
        auto ch11_delay = SADF::make_delayn("ch11_delay", array<int,2>{}, 1, *ch11_delaysig, *ch11);
        auto ch12_delay = SADF::make_delayn("ch12_delay", array<int,3>{}, 2, *ch12_delaysig, *ch12);
        auto ch13_delay = SADF::make_delayn("ch13_delay", array<int,2>{}, 1, *ch13_delaysig, *ch13);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{2}, {1, 1, 2}}}, {1, {{2}, {1, 1, 2}}}, {2, {{2}, {1, 1, 2}}}, {3, {{2}, {1, 1, 2}}}, {4, {{2}, {1, 1, 2}}}, {5, {{2}, {1, 1, 2}}}, {6, {{2}, {1, 1, 2}}}, {7, {{2}, {1, 1, 2}}}}, tie(*ch14, *ch0, *ch15), *a0_detectorsig, tie( *ch12_delaysig));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{1, 1}, {1}}}, {1, {{1, 1}, {1}}}, {2, {{1, 1}, {1}}}, {3, {{1, 1}, {1}}}, {4, {{1, 1}, {1}}}, {5, {{1, 1}, {1}}}, {6, {{1, 1}, {1}}}, {7, {{1, 1}, {1}}}}, tie(*ch1), *a1_detectorsig, tie( *ch0, *ch7_delaysig));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{1, 1}, {3, 1}}}, {1, {{1, 1}, {1, 1}}}, {2, {{1, 1}, {2, 1}}}, {3, {{1, 1}, {2, 1}}}, {4, {{1, 1}, {2, 1}}}, {5, {{1, 1}, {1, 1}}}, {6, {{1, 1}, {2, 1}}}, {7, {{1, 1}, {1, 1}}}}, tie(*ch8, *ch2), *a2_detectorsig, tie( *ch6, *ch1));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{1}, {3, 1}}}, {1, {{1}, {3, 1}}}, {2, {{1}, {3, 1}}}, {3, {{1}, {3, 1}}}, {4, {{1}, {3, 1}}}, {5, {{1}, {3, 1}}}, {6, {{1}, {3, 1}}}, {7, {{1}, {3, 1}}}}, tie(*ch3, *ch13), *a3_detectorsig, tie( *ch2_delaysig));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{2, 1, 2}, {1, 2}}}, {1, {{2, 1, 2}, {1, 2}}}, {2, {{2, 1, 2}, {1, 2}}}, {3, {{2, 1, 2}, {1, 2}}}, {4, {{2, 1, 2}, {1, 2}}}, {5, {{2, 1, 2}, {1, 2}}}, {6, {{2, 1, 2}, {1, 2}}}, {7, {{2, 1, 2}, {1, 2}}}}, tie(*ch16, *ch4), *a4_detectorsig, tie( *ch17, *ch3, *ch5));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{3}, {3, 1}}}, {1, {{3}, {3, 1}}}, {2, {{3}, {3, 1}}}, {3, {{3}, {3, 1}}}, {4, {{3}, {3, 1}}}, {5, {{3}, {3, 1}}}, {6, {{3}, {3, 1}}}, {7, {{3}, {3, 1}}}}, tie(*ch17, *ch12), *a5_detectorsig, tie( *ch4_delaysig));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{1, 2}, {3, 2}}}, {1, {{1, 2}, {3, 2}}}, {2, {{1, 2}, {3, 2}}}, {3, {{1, 2}, {3, 2}}}, {4, {{1, 2}, {3, 2}}}, {5, {{1, 2}, {3, 2}}}, {6, {{1, 2}, {3, 2}}}, {7, {{1, 2}, {3, 2}}}}, tie(*ch5, *ch10), *a6_detectorsig, tie( *ch15, *ch10_delaysig));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{1, 1, 3}, {1}}}, {1, {{1, 1, 3}, {1}}}, {2, {{1, 1, 3}, {1}}}, {3, {{1, 1, 3}, {1}}}, {4, {{1, 1, 3}, {1}}}, {5, {{1, 1, 3}, {1}}}, {6, {{1, 1, 3}, {1}}}, {7, {{1, 1, 3}, {1}}}}, tie(*ch6), *a7_detectorsig, tie( *ch14, *ch13_delaysig, *ch16));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{1, 3}, {1, 1}}}, {1, {{1, 1}, {1, 1}}}, {2, {{1, 2}, {1, 1}}}, {3, {{1, 2}, {1, 1}}}, {4, {{1, 2}, {1, 1}}}, {5, {{1, 1}, {1, 1}}}, {6, {{1, 2}, {1, 1}}}, {7, {{1, 1}, {1, 1}}}}, tie(*ch7, *ch11), *a8_detectorsig, tie( *ch11_delaysig, *ch9));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{1}, {1}}}, {1, {{1}, {1}}}, {2, {{1}, {1}}}, {3, {{1}, {1}}}, {4, {{1}, {1}}}, {5, {{1}, {1}}}, {6, {{1}, {1}}}, {7, {{1}, {1}}}}, tie(*ch9), *a9_detectorsig, tie( *ch8));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{1, 1, 1, 1, 3, 2, 2, 1, 1, 3}},{1,{1, 1, 1, 1, 3, 2, 2, 1, 1, 2}},{2,{1, 1, 1, 1, 3, 2, 2, 1, 1, 2}},{3,{1, 1, 1, 1, 3, 2, 2, 1, 1, 1}},{4,{1, 1, 1, 1, 3, 2, 2, 1, 1, 2}},{5,{1, 1, 1, 1, 3, 2, 2, 1, 1, 1}},{6,{1, 1, 1, 1, 3, 2, 2, 1, 1, 2}},{7,{1, 1, 1, 1, 3, 2, 2, 1, 1, 1}}}, 3, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig), tie());
    }
};
