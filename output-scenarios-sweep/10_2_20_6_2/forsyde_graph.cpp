...
void a2_func(tuple<vector<array<int,2>>, vector<array<int,2>>, vector<array<int,4>>>& out,
    const unsigned int& _scenario_state,
...
void a3_func(tuple<vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a4_func(tuple<vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>, vector<array<int,3>>, vector<array<int,3>>, vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
        case 0: {
            for(j=0;j<19;j++)
...
void a6_func(tuple<vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void detectorcds_func(int& new_scenario,
    ...
    switch(previous_scenario) {
        case 0: {
            unsigned int trans_dests[] = {0, 1, 2, 3, 4, 5};
            new_scenario = trans_dests[rand()%6];
            break;
        }
        case 1: {
            unsigned int trans_dests[] = {0, 1, 2, 3, 4, 5};
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{3, 3, 3, 1, 2, 2, 2, 1, 1, 2}},{1,{1, 3, 1, 2, 3, 2, 2, 2, 1, 2}},{2,{2, 3, 2, 1, 1, 2, 2, 1, 3, 2}},{3,{1, 3, 3, 2, 2, 1, 2, 2, 2, 2}},{4,{2, 3, 2, 1, 3, 2, 2, 2, 1, 2}},{5,{3, 3, 2, 2, 1, 1, 2, 1, 1, 2}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{3}, {3}}}, {1, {{3}, {3}}}, {2, {{3}, {2}}}, {3, {{3}, {1}}}, {4, {{3}, {2}}}, {5, {{3}, {2}}}}, tie(*ch1), *a0_detectorsig, tie( *ch0));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{2, 2}, {3}}}, {1, {{2, 2}, {1}}}, {2, {{2, 2}, {2}}}, {3, {{2, 2}, {1}}}, {4, {{2, 2}, {2}}}, {5, {{2, 2}, {3}}}}, tie(*ch0), *a1_detectorsig, tie( *ch14_delaysig, *ch13_delaysig));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{3}, {1, 2, 1}}}, {1, {{1}, {2, 1, 2}}}, {2, {{2}, {1, 2, 3}}}, {3, {{1}, {2, 2, 1}}}, {4, {{2}, {1, 2, 1}}}, {5, {{3}, {2, 1, 1}}}}, tie(*ch2, *ch4, *ch12), *a2_detectorsig, tie( *ch1));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{3}, {2, 2}}}, {1, {{3}, {2, 2}}}, {2, {{2}, {1, 1}}}, {3, {{1}, {3, 3}}}, {4, {{2}, {3, 3}}}, {5, {{2}, {1, 1}}}}, tie(*ch10, *ch3), *a3_detectorsig, tie( *ch2));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{1, 2, 1, 1}, {1}}}, {1, {{2, 2, 2, 2}, {2}}}, {2, {{1, 2, 1, 3}, {1}}}, {3, {{2, 2, 2, 1}, {2}}}, {4, {{1, 2, 1, 1}, {2}}}, {5, {{2, 2, 2, 1}, {1}}}}, tie(*ch6), *a4_detectorsig, tie( *ch10, *ch11, *ch3, *ch7));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{3}, {2, 2}}}, {1, {{3}, {2, 2}}}, {2, {{2}, {2, 2}}}, {3, {{1}, {2, 2}}}, {4, {{2}, {2, 2}}}, {5, {{2}, {2, 2}}}}, tie(*ch9, *ch5), *a5_detectorsig, tie( *ch4));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{2}, {2, 3}}}, {1, {{1}, {2, 3}}}, {2, {{2}, {1, 3}}}, {3, {{2}, {3, 3}}}, {4, {{2}, {3, 3}}}, {5, {{1}, {1, 3}}}}, tie(*ch11, *ch14), *a6_detectorsig, tie( *ch5));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{2}, {2}}}, {1, {{2}, {2}}}, {2, {{1}, {2}}}, {3, {{3}, {2}}}, {4, {{3}, {2}}}, {5, {{1}, {2}}}}, tie(*ch8), *a7_detectorsig, tie( *ch6));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{3}, {2}}}, {1, {{3}, {2}}}, {2, {{2}, {1}}}, {3, {{1}, {3}}}, {4, {{2}, {3}}}, {5, {{2}, {1}}}}, tie(*ch7), *a8_detectorsig, tie( *ch12));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{1, 2}, {3}}}, {1, {{2, 1}, {3}}}, {2, {{1, 2}, {3}}}, {3, {{2, 2}, {3}}}, {4, {{2, 2}, {3}}}, {5, {{1, 1}, {3}}}}, tie(*ch13), *a9_detectorsig, tie( *ch8, *ch9));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{3, 3, 3, 1, 2, 2, 2, 1, 1, 2}},{1,{1, 3, 1, 2, 3, 2, 2, 2, 1, 2}},{2,{2, 3, 2, 1, 1, 2, 2, 1, 3, 2}},{3,{1, 3, 3, 2, 2, 1, 2, 2, 2, 2}},{4,{2, 3, 2, 1, 3, 2, 2, 2, 1, 2}},{5,{3, 3, 2, 2, 1, 1, 2, 1, 1, 2}}}, 2, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig), tie());
    }
};
