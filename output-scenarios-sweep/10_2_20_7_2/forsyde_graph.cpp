...
void a0_func(tuple<vector<array<int,3>>, vector<array<int,4>>>& out,
...
void a2_func(tuple<vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,4>>, vector<array<int,4>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
        case 0: {
            for(j=0;j<20;j++)
...
void a4_func(tuple<vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>, vector<array<int,3>>, vector<array<int,4>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
        case 0: {
            for(j=0;j<20;j++)
...
void a5_func(tuple<vector<array<int,4>>, vector<array<int,4>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a6_func(tuple<vector<array<int,4>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,3>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void a9_func(tuple<vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void detectorcds_func(int& new_scenario,
    ...
    switch(previous_scenario) {
        case 0: {
            unsigned int trans_dests[] = {0, 1, 2, 3, 4, 5, 6};
            new_scenario = trans_dests[rand()%7];
            break;
        }
        case 1: {
            unsigned int trans_dests[] = {0, 1, 2, 3, 4, 5, 6};
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{3, 3, 3, 2, 1, 3, 3, 2, 1, 1}},{1,{3, 2, 3, 4, 1, 3, 1, 3, 1, 1}},{2,{3, 1, 3, 1, 1, 3, 2, 2, 1, 1}},{3,{3, 2, 3, 2, 1, 3, 1, 1, 1, 1}},{4,{3, 2, 3, 2, 1, 3, 1, 2, 1, 1}},{5,{3, 2, 3, 1, 1, 3, 2, 1, 1, 1}},{6,{3, 1, 3, 1, 1, 3, 2, 1, 1, 1}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch15_delay = SADF::make_delayn("ch15_delay", array<int,4>{}, 9, *ch15_delaysig, *ch15);
        auto ch16_delay = SADF::make_delayn("ch16_delay", array<int,3>{}, 1, *ch16_delaysig, *ch16);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{3}, {1, 1}}}, {1, {{2}, {1, 1}}}, {2, {{1}, {1, 1}}}, {3, {{2}, {1, 1}}}, {4, {{2}, {1, 1}}}, {5, {{2}, {1, 1}}}, {6, {{1}, {1, 1}}}}, tie(*ch12, *ch9), *a0_detectorsig, tie( *ch0));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{3, 2}, {3, 1}}}, {1, {{3, 2}, {3, 1}}}, {2, {{3, 1}, {3, 1}}}, {3, {{3, 4}, {3, 1}}}, {4, {{3, 2}, {3, 1}}}, {5, {{3, 1}, {3, 1}}}, {6, {{3, 1}, {3, 1}}}}, tie(*ch0, *ch3), *a1_detectorsig, tie( *ch1, *ch2));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{3, 3}, {3, 2}}}, {1, {{3, 1}, {2, 1}}}, {2, {{3, 2}, {1, 2}}}, {3, {{3, 1}, {2, 3}}}, {4, {{3, 1}, {2, 2}}}, {5, {{3, 2}, {2, 1}}}, {6, {{3, 2}, {1, 1}}}}, tie(*ch1, *ch6), *a2_detectorsig, tie( *ch15_delaysig, *ch5));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{1, 1}, {3}}}, {1, {{1, 1}, {2}}}, {2, {{1, 1}, {1}}}, {3, {{1, 1}, {2}}}, {4, {{1, 1}, {2}}}, {5, {{1, 1}, {2}}}, {6, {{1, 1}, {1}}}}, tie(*ch2), *a3_detectorsig, tie( *ch8, *ch13));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{3, 3, 3}, {1}}}, {1, {{2, 3, 3}, {1}}}, {2, {{1, 3, 3}, {1}}}, {3, {{2, 3, 3}, {1}}}, {4, {{2, 3, 3}, {1}}}, {5, {{2, 3, 3}, {1}}}, {6, {{1, 3, 3}, {1}}}}, tie(*ch16), *a4_detectorsig, tie( *ch3, *ch10, *ch4));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{2}, {1, 3, 1}}}, {1, {{1}, {1, 3, 1}}}, {2, {{2}, {1, 3, 1}}}, {3, {{3}, {1, 3, 1}}}, {4, {{2}, {1, 3, 1}}}, {5, {{1}, {1, 3, 1}}}, {6, {{1}, {1, 3, 1}}}}, tie(*ch4, *ch15, *ch10), *a5_detectorsig, tie( *ch14));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{1}, {3, 2}}}, {1, {{1}, {3, 1}}}, {2, {{1}, {3, 2}}}, {3, {{1}, {3, 3}}}, {4, {{1}, {3, 2}}}, {5, {{1}, {3, 1}}}, {6, {{1}, {3, 1}}}}, tie(*ch5, *ch11), *a6_detectorsig, tie( *ch7));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{3, 3}, {3}}}, {1, {{3, 1}, {3}}}, {2, {{3, 2}, {3}}}, {3, {{3, 1}, {3}}}, {4, {{3, 1}, {3}}}, {5, {{3, 2}, {3}}}, {6, {{3, 2}, {3}}}}, tie(*ch14), *a7_detectorsig, tie( *ch6, *ch11));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{1}, {3}}}, {1, {{1}, {1}}}, {2, {{1}, {2}}}, {3, {{1}, {1}}}, {4, {{1}, {1}}}, {5, {{1}, {2}}}, {6, {{1}, {2}}}}, tie(*ch7), *a8_detectorsig, tie( *ch16_delaysig));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{3, 3}, {2, 2}}}, {1, {{3, 3}, {2, 2}}}, {2, {{3, 3}, {1, 1}}}, {3, {{3, 3}, {4, 4}}}, {4, {{3, 3}, {2, 2}}}, {5, {{3, 3}, {1, 1}}}, {6, {{3, 3}, {1, 1}}}}, tie(*ch13, *ch8), *a9_detectorsig, tie( *ch12_delaysig, *ch9_delaysig));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{3, 3, 3, 2, 1, 3, 3, 2, 1, 1}},{1,{3, 2, 3, 4, 1, 3, 1, 3, 1, 1}},{2,{3, 1, 3, 1, 1, 3, 2, 2, 1, 1}},{3,{3, 2, 3, 2, 1, 3, 1, 1, 1, 1}},{4,{3, 2, 3, 2, 1, 3, 1, 2, 1, 1}},{5,{3, 2, 3, 1, 1, 3, 2, 1, 1, 1}},{6,{3, 1, 3, 1, 1, 3, 2, 1, 1, 1}}}, 2, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig), tie());
    }
};
