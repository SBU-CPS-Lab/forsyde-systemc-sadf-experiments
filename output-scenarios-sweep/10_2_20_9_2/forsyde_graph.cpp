...
void a0_func(tuple<vector<array<int,3>>, vector<array<int,2>>, vector<array<int,3>>>& out,
...
void a2_func(tuple<vector<array<int,4>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void detectorcds_func(int& new_scenario,
    ...
    switch(previous_scenario) {
        case 0: {
            unsigned int trans_dests[] = {0, 1, 2, 3, 4, 5, 6, 7, 8};
            new_scenario = trans_dests[rand()%9];
            break;
        }
        case 1: {
            unsigned int trans_dests[] = {0, 1, 2, 3, 4, 5, 6, 7, 8};
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{2, 2, 1, 2, 2, 2, 1, 1, 2, 1}},{1,{2, 1, 2, 2, 2, 2, 1, 2, 2, 1}},{2,{2, 2, 2, 1, 2, 1, 1, 1, 2, 1}},{3,{2, 1, 1, 1, 2, 1, 1, 2, 2, 1}},{4,{2, 3, 2, 2, 2, 2, 1, 1, 2, 1}},{5,{2, 2, 1, 1, 2, 2, 1, 4, 2, 1}},{6,{2, 2, 3, 2, 2, 1, 1, 1, 2, 1}},{7,{2, 1, 1, 3, 2, 3, 1, 2, 2, 1}},{8,{2, 1, 2, 2, 2, 1, 1, 2, 2, 1}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch7_delay = SADF::make_delayn("ch7_delay", array<int,3>{}, 2, *ch7_delaysig, *ch7);
        ...
        auto ch13_delay = SADF::make_delayn("ch13_delay", array<int,3>{}, 4, *ch13_delaysig, *ch13);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{2, 1}, {2, 1, 2}}}, {1, {{3, 1}, {2, 1, 2}}}, {2, {{1, 1}, {2, 1, 2}}}, {3, {{1, 1}, {2, 1, 2}}}, {4, {{2, 1}, {2, 1, 2}}}, {5, {{2, 1}, {2, 1, 2}}}, {6, {{2, 1}, {2, 1, 2}}}, {7, {{1, 1}, {2, 1, 2}}}, {8, {{1, 1}, {2, 1, 2}}}}, tie(*ch10, *ch8, *ch13), *a0_detectorsig, tie( *ch0, *ch12_delaysig));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{1, 2}, {2}}}, {1, {{2, 2}, {2}}}, {2, {{2, 2}, {2}}}, {3, {{1, 2}, {2}}}, {4, {{2, 2}, {2}}}, {5, {{1, 2}, {2}}}, {6, {{3, 2}, {2}}}, {7, {{1, 2}, {2}}}, {8, {{2, 2}, {2}}}}, tie(*ch0), *a1_detectorsig, tie( *ch1, *ch3));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{2}, {2, 2}}}, {1, {{2}, {3, 2}}}, {2, {{2}, {1, 2}}}, {3, {{1}, {1, 2}}}, {4, {{1}, {2, 2}}}, {5, {{1}, {2, 2}}}, {6, {{2}, {2, 2}}}, {7, {{3}, {1, 2}}}, {8, {{2}, {1, 2}}}}, tie(*ch1, *ch14), *a2_detectorsig, tie( *ch2));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{2}, {1}}}, {1, {{2}, {2}}}, {2, {{2}, {2}}}, {3, {{1}, {1}}}, {4, {{1}, {2}}}, {5, {{2}, {1}}}, {6, {{1}, {3}}}, {7, {{3}, {1}}}, {8, {{1}, {2}}}}, tie(*ch2), *a3_detectorsig, tie( *ch4));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{2, 2}, {2}}}, {1, {{2, 2}, {3}}}, {2, {{2, 2}, {1}}}, {3, {{2, 2}, {1}}}, {4, {{2, 2}, {2}}}, {5, {{2, 2}, {2}}}, {6, {{2, 2}, {2}}}, {7, {{2, 2}, {1}}}, {8, {{2, 2}, {1}}}}, tie(*ch3), *a4_detectorsig, tie( *ch10_delaysig, *ch13_delaysig));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{1}, {2}}}, {1, {{1}, {2}}}, {2, {{1}, {2}}}, {3, {{1}, {1}}}, {4, {{1}, {1}}}, {5, {{1}, {1}}}, {6, {{1}, {2}}}, {7, {{1}, {3}}}, {8, {{1}, {2}}}}, tie(*ch4), *a5_detectorsig, tie( *ch5));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{2, 1}, {2}}}, {1, {{2, 1}, {2}}}, {2, {{2, 2}, {2}}}, {3, {{2, 2}, {1}}}, {4, {{2, 1}, {1}}}, {5, {{2, 4}, {2}}}, {6, {{2, 1}, {1}}}, {7, {{2, 2}, {3}}}, {8, {{2, 2}, {1}}}}, tie(*ch5), *a6_detectorsig, tie( *ch7_delaysig, *ch6));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{1}, {1}}}, {1, {{1}, {1}}}, {2, {{1}, {1}}}, {3, {{1}, {1}}}, {4, {{1}, {1}}}, {5, {{1}, {1}}}, {6, {{1}, {1}}}, {7, {{1}, {1}}}, {8, {{1}, {1}}}}, tie(*ch6), *a7_detectorsig, tie( *ch11));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{1, 1}, {1}}}, {1, {{1, 2}, {1}}}, {2, {{1, 2}, {1}}}, {3, {{1, 1}, {1}}}, {4, {{1, 2}, {1}}}, {5, {{1, 1}, {1}}}, {6, {{1, 3}, {1}}}, {7, {{1, 1}, {1}}}, {8, {{1, 2}, {1}}}}, tie(*ch7), *a8_detectorsig, tie( *ch9, *ch14));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{2}, {2, 2, 1}}}, {1, {{2}, {2, 2, 1}}}, {2, {{2}, {2, 2, 2}}}, {3, {{2}, {2, 2, 2}}}, {4, {{2}, {2, 2, 1}}}, {5, {{2}, {2, 2, 4}}}, {6, {{2}, {2, 2, 1}}}, {7, {{2}, {2, 2, 2}}}, {8, {{2}, {2, 2, 2}}}}, tie(*ch9, *ch12, *ch11), *a9_detectorsig, tie( *ch8_delaysig));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{2, 2, 1, 2, 2, 2, 1, 1, 2, 1}},{1,{2, 1, 2, 2, 2, 2, 1, 2, 2, 1}},{2,{2, 2, 2, 1, 2, 1, 1, 1, 2, 1}},{3,{2, 1, 1, 1, 2, 1, 1, 2, 2, 1}},{4,{2, 3, 2, 2, 2, 2, 1, 1, 2, 1}},{5,{2, 2, 1, 1, 2, 2, 1, 4, 2, 1}},{6,{2, 2, 3, 2, 2, 1, 1, 1, 2, 1}},{7,{2, 1, 1, 3, 2, 3, 1, 2, 2, 1}},{8,{2, 1, 2, 2, 2, 1, 1, 2, 2, 1}}}, 2, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig), tie());
    }
};
