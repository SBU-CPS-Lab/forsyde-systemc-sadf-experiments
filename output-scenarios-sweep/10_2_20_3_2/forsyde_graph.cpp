...
void a2_func(tuple<vector<array<int,3>>, vector<array<int,4>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a4_func(tuple<vector<array<int,4>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a9_func(tuple<vector<array<int,2>>, vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
    const tuple<vector<array<int,2>>>& inp) {
    static int i=0;volatile int j,k,l;
    switch(_scenario_state) {
...
void detectorcds_func(int& new_scenario,
    ...
    switch(previous_scenario) {
        case 0: {
            unsigned int trans_dests[] = {0, 1, 2};
            new_scenario = trans_dests[rand()%3];
            break;
        }
        case 1: {
            unsigned int trans_dests[] = {0, 1, 2};
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{1, 1, 2, 2, 1, 1, 2, 1, 1, 1}},{1,{1, 1, 2, 1, 3, 2, 2, 1, 1, 1}},{2,{1, 1, 2, 4, 3, 2, 2, 1, 1, 1}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch7 = new SADF::signal<array<int,4>>("ch7", 16);
        ...
        auto ch0_delaysig = new SADF::signal<array<int,1>>("ch0_delaysig", 16);
        auto ch1_delaysig = new SADF::signal<array<int,2>>("ch1_delaysig", 16);
        auto ch7_delaysig = new SADF::signal<array<int,4>>("ch7_delaysig", 16);
        ...
        auto ch0_delay = SADF::make_delayn("ch0_delay", array<int,1>{}, 1, *ch0_delaysig, *ch0);
        auto ch1_delay = SADF::make_delayn("ch1_delay", array<int,2>{}, 2, *ch1_delaysig, *ch1);
        auto ch7_delay = SADF::make_delayn("ch7_delay", array<int,4>{}, 2, *ch7_delaysig, *ch7);
        auto ch9_delay = SADF::make_delayn("ch9_delay", array<int,3>{}, 1, *ch9_delaysig, *ch9);
        auto ch11_delay = SADF::make_delayn("ch11_delay", array<int,3>{}, 4, *ch11_delaysig, *ch11);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{1, 1}, {1}}}, {1, {{1, 2}, {1}}}, {2, {{1, 2}, {1}}}}, tie(*ch0), *a0_detectorsig, tie( *ch14, *ch4));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{1, 1, 1}, {2}}}, {1, {{1, 3, 3}, {2}}}, {2, {{1, 3, 3}, {2}}}}, tie(*ch1), *a1_detectorsig, tie( *ch0_delaysig, *ch15, *ch10));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{1, 2, 1}, {1, 2, 2}}}, {1, {{1, 2, 1}, {1, 4, 2}}}, {2, {{1, 2, 1}, {1, 1, 2}}}}, tie(*ch6, *ch2, *ch5), *a2_detectorsig, tie( *ch8, *ch11_delaysig, *ch1_delaysig));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{2}, {1}}}, {1, {{2}, {3}}}, {2, {{2}, {3}}}}, tie(*ch3), *a3_detectorsig, tie( *ch2));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{2}, {1, 1}}}, {1, {{4}, {1, 1}}}, {2, {{1}, {1, 1}}}}, tie(*ch10, *ch15), *a4_detectorsig, tie( *ch3));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{1}, {1}}}, {1, {{1}, {1}}}, {2, {{1}, {1}}}}, tie(*ch4), *a5_detectorsig, tie( *ch12));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{2}, {1, 2}}}, {1, {{2}, {1, 2}}}, {2, {{2}, {1, 2}}}}, tie(*ch7, *ch11), *a6_detectorsig, tie( *ch5));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{2, 1}, {1}}}, {1, {{2, 1}, {2}}}, {2, {{2, 1}, {2}}}}, tie(*ch12), *a7_detectorsig, tie( *ch6, *ch9_delaysig));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{2}, {1}}}, {1, {{2}, {1}}}, {2, {{2}, {1}}}}, tie(*ch13), *a8_detectorsig, tie( *ch7_delaysig));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{1}, {2, 1, 1}}}, {1, {{1}, {2, 1, 1}}}, {2, {{1}, {2, 1, 1}}}}, tie(*ch8, *ch9, *ch14), *a9_detectorsig, tie( *ch13));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{1, 1, 2, 2, 1, 1, 2, 1, 1, 1}},{1,{1, 1, 2, 1, 3, 2, 2, 1, 1, 1}},{2,{1, 1, 2, 4, 3, 2, 2, 1, 1, 1}}}, 0, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig), tie());
    }
};
