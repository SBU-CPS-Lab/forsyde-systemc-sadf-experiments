...
void a1_func(tuple<vector<array<int,3>>, vector<array<int,3>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a2_func(tuple<vector<array<int,2>>, vector<array<int,2>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void a6_func(tuple<vector<array<int,1>>, vector<array<int,2>>, vector<array<int,2>>>& out,
    const unsigned int& _scenario_state,
...
void a8_func(tuple<vector<array<int,3>>, vector<array<int,3>>, vector<array<int,3>>>& out,
    const unsigned int& _scenario_state,
...
void detectorcds_func(int& new_scenario,
    ...
    switch(previous_scenario) {
        case 0: {
            unsigned int trans_dests[] = {0, 1, 2, 3};
            new_scenario = trans_dests[rand()%4];
            break;
        }
        case 1: {
            unsigned int trans_dests[] = {0, 1, 2, 3};
...
map<unsigned int,vector<unsigned int>> detector1_scenario_table {{0,{1, 2, 1, 3, 2, 1, 1, 1, 3, 3}},{1,{1, 2, 1, 3, 2, 1, 1, 1, 3, 3}},{2,{1, 2, 1, 3, 2, 1, 1, 1, 3, 3}},{3,{1, 2, 1, 1, 2, 1, 1, 1, 3, 3}}};
...
SC_MODULE(sdf3_graph_repeatitions) {
    SC_CTOR(sdf3_graph_repeatitions) {
        ...
        auto ch17_delaysig = new SADF::signal<array<int,1>>("ch17_delaysig", 16);
        ...
        auto ch8_delay = SADF::make_delayn("ch8_delay", array<int,2>{}, 6, *ch8_delaysig, *ch8);
        auto ch9_delay = SADF::make_delayn("ch9_delay", array<int,2>{}, 3, *ch9_delaysig, *ch9);
        auto ch10_delay = SADF::make_delayn("ch10_delay", array<int,3>{}, 3, *ch10_delaysig, *ch10);
        auto ch11_delay = SADF::make_delayn("ch11_delay", array<int,2>{}, 3, *ch11_delaysig, *ch11);
        auto ch17_delay = SADF::make_delayn("ch17_delay", array<int,1>{}, 3, *ch17_delaysig, *ch17);
        auto ch19_delay = SADF::make_delayn("ch19_delay", array<int,2>{}, 1, *ch19_delaysig, *ch19);
        auto ch20_delay = SADF::make_delayn("ch20_delay", array<int,3>{}, 2, *ch20_delaysig, *ch20);
        auto a0 = SADF::make_kernelMN("a0", a0_func, {{0, {{1, 3}, {2}}}, {1, {{1, 1}, {2}}}, {2, {{1, 3}, {2}}}, {3, {{1, 3}, {2}}}}, tie(*ch0), *a0_detectorsig, tie( *ch1, *ch2));
        auto a1 = SADF::make_kernelMN("a1", a1_func, {{0, {{1, 1}, {3, 1, 2}}}, {1, {{1, 1}, {3, 1, 2}}}, {2, {{1, 1}, {3, 1, 2}}}, {3, {{1, 1}, {3, 1, 2}}}}, tie(*ch15, *ch20, *ch3), *a1_detectorsig, tie( *ch4_delaysig, *ch0_delaysig));
        auto a2 = SADF::make_kernelMN("a2", a2_func, {{0, {{3, 1, 3}, {1, 1, 3}}}, {1, {{3, 1, 3}, {1, 1, 3}}}, {2, {{3, 1, 3}, {1, 1, 3}}}, {3, {{3, 1, 3}, {1, 1, 3}}}}, tie(*ch1, *ch19, *ch10), *a2_detectorsig, tie( *ch11_delaysig, *ch5, *ch14));
        auto a3 = SADF::make_kernelMN("a3", a3_func, {{0, {{1, 1}, {1}}}, {1, {{1, 1}, {1}}}, {2, {{1, 1}, {1}}}, {3, {{1, 1}, {1}}}}, tie(*ch2), *a3_detectorsig, tie( *ch18, *ch16));
        auto a4 = SADF::make_kernelMN("a4", a4_func, {{0, {{3, 2}, {1, 3}}}, {1, {{3, 2}, {1, 3}}}, {2, {{3, 2}, {1, 3}}}, {3, {{3, 2}, {1, 3}}}}, tie(*ch12, *ch8), *a4_detectorsig, tie( *ch21, *ch3));
        auto a5 = SADF::make_kernelMN("a5", a5_func, {{0, {{1, 2, 1}, {3, 2}}}, {1, {{1, 2, 1}, {1, 2}}}, {2, {{1, 2, 1}, {3, 2}}}, {3, {{1, 2, 1}, {3, 2}}}}, tie(*ch16, *ch4), *a5_detectorsig, tie( *ch6_delaysig, *ch20_delaysig, *ch19_delaysig));
        auto a6 = SADF::make_kernelMN("a6", a6_func, {{0, {{3}, {3, 1, 3}}}, {1, {{3}, {3, 1, 3}}}, {2, {{3}, {3, 1, 3}}}, {3, {{3}, {3, 1, 3}}}}, tie(*ch17, *ch5, *ch9), *a6_detectorsig, tie( *ch13));
        auto a7 = SADF::make_kernelMN("a7", a7_func, {{0, {{2, 3}, {3, 1}}}, {1, {{2, 3}, {1, 1}}}, {2, {{2, 3}, {3, 1}}}, {3, {{2, 3}, {3, 1}}}}, tie(*ch18, *ch6), *a7_detectorsig, tie( *ch12, *ch7));
        auto a8 = SADF::make_kernelMN("a8", a8_func, {{0, {{2, 1, 1}, {1, 1, 1}}}, {1, {{2, 1, 1}, {1, 1, 1}}}, {2, {{2, 1, 1}, {1, 1, 1}}}, {3, {{2, 1, 1}, {1, 1, 1}}}}, tie(*ch13, *ch14, *ch7), *a8_detectorsig, tie( *ch15, *ch17_delaysig, *ch10_delaysig));
        auto a9 = SADF::make_kernelMN("a9", a9_func, {{0, {{1, 2}, {1, 2}}}, {1, {{1, 2}, {1, 2}}}, {2, {{1, 2}, {1, 2}}}, {3, {{1, 2}, {1, 2}}}}, tie(*ch11, *ch21), *a9_detectorsig, tie( *ch9_delaysig, *ch8_delaysig));
        auto detector1 = SADF::make_detectorMN("detector1", detectorcds_func, detectorkss_func, {{0,{1, 2, 1, 3, 2, 1, 1, 1, 3, 3}},{1,{1, 2, 1, 3, 2, 1, 1, 1, 3, 3}},{2,{1, 2, 1, 3, 2, 1, 1, 1, 3, 3}},{3,{1, 2, 1, 1, 2, 1, 1, 1, 3, 3}}}, 2, {}, tie(*a0_detectorsig, *a1_detectorsig, *a2_detectorsig, *a3_detectorsig, *a4_detectorsig, *a5_detectorsig, *a6_detectorsig, *a7_detectorsig, *a8_detectorsig, *a9_detectorsig), tie());
    }
};
